...
| 3 | [DHCP relay troubleshooting](dhcp-relay/) | Common junior support address-assignment ticket | In progress | `.pkt`, baseline evidence, both identified gateway pings, and G0/0.10 fault with PC1 failure/PC2 control and PC1 recovery present; add final configs/`.pkt` and identified post-repair server pings |
