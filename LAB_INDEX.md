...
| 3 | [DHCP relay troubleshooting](dhcp-relay/) | Common junior support address-assignment ticket | Documentation ready | Build `.pkt`; capture topology, configs, before/after client lease and relay/server state, and genuine fault record |
