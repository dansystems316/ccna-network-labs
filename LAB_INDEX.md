...
| 3 | [DHCP relay troubleshooting](dhcp-relay/) | Common junior support address-assignment ticket | In progress | Inspect supplied `.pkt` in Packet Tracer; reconcile topology/addressing, then capture configs, before/after leases and relay/server state, and genuine fault record |
