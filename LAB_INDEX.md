...
| 3 | [DHCP relay troubleshooting](dhcp-relay/) | Common junior support address-assignment ticket | In progress | `.pkt`, topology, VLAN/trunk, R1 helpers, both client leases and matching server bindings present; capture current DHCP config to reconcile earlier missing ADMINPOOL gateway, server routes, pings, saved configs and genuine fault/repair proof |
