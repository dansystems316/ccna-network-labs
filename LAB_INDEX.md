...
| 3 | [DHCP relay troubleshooting](dhcp-relay/) | Common junior support address-assignment ticket | In progress | `.pkt`, topology and baseline switch/router/DHCP screenshots present; correct missing ADMINPOOL gateway, verify helper and routes, capture both client leases, configs, reachability and genuine fault/repair proof |
