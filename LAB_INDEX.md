...
| 3 | [DHCP relay troubleshooting](dhcp-relay/) | Common junior support address-assignment ticket | In progress | `.pkt`, baseline network evidence and a partial helper-removal/APIPA/recovery case present; identify faulted subinterface and client, show PC2 control, add final configs/`.pkt` and attributed post-repair tests |
