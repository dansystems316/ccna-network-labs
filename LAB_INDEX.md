...
| 3 | [DHCP relay troubleshooting](dhcp-relay/) | Common junior support address-assignment ticket | In progress | `.pkt`, baseline network evidence, both identified gateway pings and G0/0.10 helper-removal/APIPA/recovery case present; identify failed client in fault capture, show PC2 control during fault, add final configs/`.pkt` and identified server pings |
