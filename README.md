...
| [DHCP relay troubleshooting](dhcp-relay/) | Client address failure, relay placement, server pools, return path | In progress; both client leases captured; routes, pings, configs and failure/recovery proof pending |
