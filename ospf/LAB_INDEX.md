...
| 2 | [OSPF single area](ospf/) | Junior routing and escalation work | In progress | Add text running-config exports; `.pkt`, topology, neighbors, routes, end-to-end tests, and subnet-mask fault evidence are included |
